...
1. Learn the Kubernetes concepts and installation options in [Coriolis Operator](operator.md).
2. Prepare the [Lab Environment](operator-lab-environment.md).
3. [Deploy an Appliance](deploy-appliance.md).
