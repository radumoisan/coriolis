...
## :material-book-open-page-variant-outline: Coriolis Components
...
## :material-book-open-page-variant-outline: Coriolis Operator
...
### :material-application-edit-outline: Mental Model
...
### :material-application-edit-outline: Resource And Profile
...
### :material-application-edit-outline: Helm Installation
...
### :material-application-edit-outline: CRD First Install And Upgrade Caveat
...
1. Apply the `coriolisappliances.coriolis.cloudbase.it`<br>
...
### :material-application-edit-outline: CR Versus Helm Values, And The Two Retention Profiles
...
### :material-application-edit-outline: Reconciliation
...
### :material-application-edit-outline: Next Steps And Limitations
