...
- No Coriolis application workloads, endpoints, Ingress, or Jobs are implemented or deployed. Remaining Services and dependency workload/bootstrap/storage/readiness/rotation design are later work.
