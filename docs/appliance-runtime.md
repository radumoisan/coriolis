...
- No core workloads are implemented or deployed. Services, Ingress, workloads, provider/bootstrap/storage/readiness/rotation, and remaining runtime design are later work; deployed `0.5.3` remains marker-only.
