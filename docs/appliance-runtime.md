...
- No core runtime workloads are implemented or deployed; the remaining gates are the actual generators/builders, reconcile reads/SSA/RBAC, the TLS/CA private layout, optional component credentials, storage, probes/readiness/bootstrap, and rotation rollout.
