...
- A common bootstrap Job has been accepted. No Coriolis application workloads, endpoints, or Ingress are deployed; backend/application Services and workloads, then Ingress, are next. `Ready=False/RuntimeNotImplemented` remains truthful, and production gates remain open.
